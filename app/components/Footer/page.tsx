...
const Footer: React.FC = () => {
  return (
    <footer className='flex justify-center py-10'>
      <div className='max-w-[1200px] w-full bg-white rounded-lg shadow-lg border border-gray-300 px-6 py-10'>
        ...
        <div className='mt-8 border-t border-b border-black pt-6 mb-16'>
